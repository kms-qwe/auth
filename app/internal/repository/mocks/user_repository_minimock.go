...
//go:generate minimock -i github.com/kms-qwe/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcUpdate          func(ctx context.Context, info *model.UserInfoUpdate) (err error)
	inspectFuncUpdate   func(ctx context.Context, info *model.UserInfoUpdate)
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, info *model.UserInfoUpdate) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) ExpectInfoParam2(info *model.UserInfoUpdate) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, info *model.UserInfoUpdate)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, info *model.UserInfoUpdate) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, info *model.UserInfoUpdate) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, info *model.UserInfoUpdate) (err error) {
